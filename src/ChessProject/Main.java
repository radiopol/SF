  ...
  /*  public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (s.equals("exit")) break;
                ...
                if (s.equals("castling0")) {
                    if (board.castling0()) {
                        System.out.println("castling0 done");
                        board.printBoard();
                    } else {
                        System.out.println("castling0 not done");
                    }
                } else if (s.equals("castling7")) {
                    if (board.castling7()) {
                        System.out.println("castling7 done");
                        board.printBoard();
                    } else {
                        System.out.println("castling7 not done");
                    }
                } else if (s.contains("move")) {
                    String[] a = s.split(" ");
                    try {
                        ...
                        if (board.moveToPosition(line, column, toLine, toColumn)) {
                            ...
                            board.printBoard();
                        } else System.out.println("move not done");
                    } catch (Exception e) {
                        System.out.println("wrong input, repeat plese");
                    }
